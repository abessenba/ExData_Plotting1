...
## 5. Create a histogram (plot 1) in red with the correct labels
...
## 5. Create a histogram (plot 1) in red with the correct labels
hist(electricConsumption$Global_active_power, xlab="Global Active Power (kilowatts)", ylab = "Frequency", col="red", main="Global Active Power")
